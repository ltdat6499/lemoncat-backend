...
module.exports = {
	...
	FlimInfo: {
		...
		theatersDate: (parent) =>
			tools.formatLLToDefault(
				parent.theaters_date === "20-12-2015"
					? "2015/12/20"
					: parent.theaters_date.replace(" limited", "")
			),
		streamingDate: (parent) =>
			tools.formatLLToDefault(
				parent.streaming_date === "20-12-2015"
					? "2015/12/20"
					: parent.streaming_date
			),
