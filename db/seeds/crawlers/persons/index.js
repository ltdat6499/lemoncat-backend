...
//   const result = $("body").find(first_image.join(" > ")).attr("src");
//   return result;
// };
...
//     .each((i, el) => {
//       results.push("https://www.rottentomatoes.com" + $(el).attr("href"));
//     });
//   $("body")
...
//   let result = $("body").find(highestRated.join(" > ")).attr("href");
//   if (result) return "https://www.rottentomatoes.com" + result;
//   return null;
// };
...
//     $("body").find(lowestRated.join(" > ")).attr("href");
//   return result;
// };
